...
window.SITE = {
  ...
  /* My personal website (hobbies, writing, blog). Paste the full address, e.g. "https://gauri.me".
     */
  personalSite: "PLACEHOLDER: https://your-personal-site.com",

  /* My GitHub username: the "Live from GitHub" strip shows your latest pushed repos. */
  github: "makkergauri",
  ...
  projects: [
    {
      ...
      role: "Built NumPy and Pandas pipelines that turn tracked player and ball positions into performance metrics such as ball possession, player speed and territory control, Cleaned and structured the tracking output so it could be used for analysis and dashboards, Optimised the YOLO detection models to reduce inference latency, helping the system run in real time, Tuned the pipeline so detection, tracking and metric computation could keep up with video frame rates and built interactive dashboards that present the metrics in a form coaches and analysts can read and use.",
